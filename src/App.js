  ...
  render() {
    ...
    const onSuccess = (payment) => {
      ...
      // You can bind the "payment" object's value to your state or props or whatever here, please see below for sample returned data
		...
		let total = 19.99;  // this is the total amount (based on currency) to charge
		// Document on Paypal's currency code: https://developer.paypal.com/docs/classic/api/currency_codes/

		const client = {
			sandbox:    'AW-K-5tXnLRoqC3zumljD-JNM5MhS5hVLtdBxGu6n2KpsyXFdtvmaiWYEfkApLJ16LmAeo-tIIu5Bt4V',
			production: 'AX14sTa9Dxa7y5r2YuxfSyd3i2jtXL2JcKF-3ZpAU9v9faVdF_sl5hSMnQymVmVteW-8Vn-1jc6_y4PK',
    }
      ...
      <MuiThemeProvider theme={theme}>
        <div style={{flexGrow: 1}}>
          <AppBar style={{alignItems: 'center'}}>
            <Toolbar >
                <Typography style={{padding: 20}} component="h1" variant="h2" color="inherit">
                  FitFam
                </Typography>
            </Toolbar>
          </AppBar>
        ...
        <div>
          <PaypalExpressBtn style={{size: 'responsive'}} env={env} client={client} currency={currency} total={total} onError={onError} onSuccess={onSuccess} onCancel={onCancel} />
        </div>
        <div>
          <Typography  style={{  marginTop: '20px', padding: 20, textAlign:"center"}} variant="h5">
            That's it, you're all done, easy right?
            <br/>
            Once your payment is confirmed, one of our coaches will create a full workout plan for you!
            <br/>
